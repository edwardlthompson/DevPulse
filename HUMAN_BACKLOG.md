...
- ✅ [HUMAN] Dispatched CI, Security Scan, CodeQL, and Release Please on `main`; `/ship` cut `v0.34.2`
- ✅ [HUMAN] Optional: set repo secret `AUTOMERGE_TOKEN` (PAT) so future bot merges start Actions without a manual `gh workflow run` (KB-031)
