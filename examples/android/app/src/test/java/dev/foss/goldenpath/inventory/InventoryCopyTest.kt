...
class InventoryCopyTest {
    ...
    fun listingMarkNeedsEvidence() {
        ...
        assertEquals("", InventoryCopy.listingMarkPrefix(ListingMark.Ignored))
    ...
    fun failResMatchesWhy() {
        ...
        assertEquals(R.string.install_fail_timeout, InventoryCopy.failRes(InstallWhy.Timeout))
        assertEquals(R.string.install_fail_no_file, InventoryCopy.failRes(InstallWhy.NoFile))
        assertEquals(R.string.update_all_no_space, InventoryCopy.failRes(InstallWhy.NoSpace))
        assertEquals(R.string.install_fail_older, InventoryCopy.failRes(InstallWhy.Older))
        assertEquals(R.string.install_fail_incompatible, InventoryCopy.failRes(InstallWhy.Sdk))
        ...
        assertEquals(R.string.install_fail_no_file, InventoryCopy.failRes(InstallWhy.ResolveMiss))
        assertEquals(
