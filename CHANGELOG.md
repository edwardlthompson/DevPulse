...
## [0.29.1](https://github.com/edwardlthompson/DevPulse/compare/v0.29.0...v0.29.1) (2026-08-22)
...
- Instrumented Settings smoke walks Appearance, Updates, and Inventory subpages
...
- Signed `DevPulse-{version}.apk` on GitHub Releases when release signing secrets are present
- Optional APKMirror and APKPure listing scans (default off; batch lookup; never downloads APKs)

### Fixed

- Aptoide listing taps open the Aptoide app or the app’s Aptoide web page, not the Aptoide home screen
...
- Scroll settings instrumented tests; open About from Settings; skip nav-clearance assert when inset is 0
